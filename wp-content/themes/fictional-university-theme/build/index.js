...
class Like {
  ...
  createLike(currentLikeBox) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      // validates the logged in user using nonce code so that wp can trust our request or perform actions
      beforeSend: xhr => {
...
class MyNotes {
  ...
  deleteNote(e) {
    var thisNote = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents("li"); // to determent what element id has been clicked
...
class Search {
  ...
  // METHODS
  getResults() {
    // SHOWING THE RESULTS TO FRONTEND FROM BACKEND CUSTOM API URL OF SEARCH AREA
    // CUSTOM LAYOUT FOR "SEARCH" OVERLAY
    ...
    // ========== USING WHEN & THEN IN GETTING MULTIPLE POST TYPE DEFAULT API  URL (FRONTEND) FROM BACKEND =========
    // $.when(
    //   $.getJSON(
    ...
    // ========== GETTING MULTIPLE POST TYPE USING ASYNCHRONOUS AND SYNCHRONOUS ==========
    // $.getJSON(
    //   universityData.root_url +
    //     "/wp-json/wp/v2/posts?search=" +
    //     this.searchField.val(),
    ...
    // ========== GETTING A RESULT USING ONLY ONE POST TYPE =========
    // $.getJSON(
    //   universityData.root_url +
    //     "/wp-json/wp/v2/posts?search=" +
    //     this.searchField.val(),
