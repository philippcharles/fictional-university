...
<body <?php body_class(); ?>>
    <header class="site-header">
      <div class="container">
        ...
        <!-- ========== THIS SEARCH ICON IS FOR RUNNING JAVASCRIPT  -->
        <!-- <span class="js-search-trigger site-header__search-trigger"><i class="fa fa-search" aria-hidden="true"></i></span> -->

        <!-- ========== THIS SEARCH ICON IS IF THE JAVASCRIPT DISABLED IT TAKES US TO SEARCH  -->
      ...
      <div class="site-header__menu group">
          <nav class="main-navigation">
            ...
            <ul>
              ...
              <!-- there is lot of conditions we can choose
                   is_home()
                   is_single()
                   is_archive()
               -->
          ...
          <!-- ========== CONNECTION OF LOGIN AND SIGNUP  ========== -->
